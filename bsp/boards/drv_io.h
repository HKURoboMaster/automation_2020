...
#define WRITE_HIGH_CAPACITOR()  HAL_GPIO_WritePin(GPIOI, GPIO_PIN_2, GPIO_PIN_SET)
#define WRITE_LOW_CAPACITOR()   HAL_GPIO_WritePin(GPIOI, GPIO_PIN_2, GPIO_PIN_RESET)
